...
namespace XRC.Assignments.Geometry
{
    public class MyQuaternion
    {
        ...
        public static MyQuaternion Inverse(MyQuaternion q)
        {
            ...
            // <solution>
            float normSquared = q.a * q.a + q.b * q.b + q.c * q.c + q.d * q.d;
            result.a = q.a / normSquared;
            result.b = -q.b / normSquared;
            result.c = -q.c / normSquared;
            result.d = -q.d / normSquared;
            // </solution>
        ...
        public void AngleAxis(float angle, Vector3 axis)
        {
            ...
            m_A = Mathf.Cos(halfAngle);
            m_B = axis.x * sinHalfAngle;
            m_C = axis.y * sinHalfAngle;
            m_D = axis.z * sinHalfAngle;
            // </solution>
        }
